...
public class TesteActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mMediaRouteItem = menu.findItem(R.id.media_route_menu_item);
                            ...
                            if (status.isSuccess()) {
                                try {
                                    ...
                                    MediaInfo mediaInfo = new MediaInfo.Builder(
                                            "https://www.youtube.com/watch?v=oaBmVaVdCVg")
